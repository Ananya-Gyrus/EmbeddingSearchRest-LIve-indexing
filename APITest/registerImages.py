...
for name in os.listdir("work_dir_sa/registered_images"):
    paths = []

    for img in os.listdir(f"work_dir_sa/registered_images/{name}"):
        image = cv2.imread(f"work_dir_sa/registered_images/{name}/{img}")
