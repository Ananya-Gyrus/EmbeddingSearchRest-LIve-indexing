...
_VALIDATE_CACHE_TTL = 10    # re-validate at most every 10 seconds (avoids hammering Vercel free tier)
...
"""
>>>>>>> 3679f2b (image registration added and cloud docker created)
